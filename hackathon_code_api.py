...
from ses_email import SesMailSender
from ses_email import send_customer_query_reply
...
def getResponse(query: str) -> str:
    ...
    for model_id in claude_model_ids:
        ...
        response = ask_bedrock_llm_with_knowledge_base(query)
        ...
        email_to = 'genaiibsteam36@gmail.com'
        email_from = 'genaiibsteam36su@gmail.com'
